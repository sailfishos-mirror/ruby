...
struct io_buffer_for_func_arguments {
    VALUE klass;
    VALUE string;
    VALUE instance;
    enum rb_io_buffer_flags flags;
...
static VALUE
io_buffer_for_func_call(VALUE _arguments)
{
...
static VALUE
io_buffer_for_func_ensure(VALUE _arguments)
{
    struct io_buffer_for_func_arguments *arguments = (struct io_buffer_for_func_arguments *)_arguments;
...
rb_io_buffer_for_reading(VALUE string_or_buffer, VALUE (*func)(VALUE, VALUE), VALUE argument)
{
    if (rb_obj_is_kind_of(string_or_buffer, rb_cIOBuffer)) {
        ...
        struct io_buffer_for_func_arguments arguments = {
            .klass = rb_cIOBuffer,
        ...
        return rb_ensure(io_buffer_for_func_call, (VALUE)&arguments,
                         io_buffer_for_func_ensure, (VALUE)&arguments);
    }
    else {
